...
<div class="card">
    ...
    <div class="card-block table-border-style">
        ...
        @endif
        <br>
        <a href="{{ route('pegawai.create') }}" class="btn btn-sm btn-primary btn-round">
            Tambah Data Pegawai
        </a>
        <br>
                ...
                <tbody>
                    @forelse ($employee as $e)
                        <tr>
                            ...
                            <td>{{ $e->telepon }}</td>
                            <td>
                                <a href="/pegawai/{{ $e->id }}/edit" type="button" class="btn btn-info btn-round btn-sm">
                                    Edit
                                </a>
                        ...
                        <!-- Modal Edit -->
                        <!-- Modal Hapus -->
                        <div class="modal fade" id="hapusModal{{ $e->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
