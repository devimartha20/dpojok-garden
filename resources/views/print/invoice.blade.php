...
<head>
	...
	<link rel="stylesheet" href="{{ asset('invoice2.css') }}">
</head>
<body>
				...
				<header class="bg-yellow restaurant-header" id="invo_header">
					<div class="invoice-logo-content">
						<div class="invoice-logo-details wid-50">
							<a href="restaurant_bill.html" class="restaurant-logo"><img src="main/assets/images/iconcafe2.png" alt="this is a invoice logo"></a>
						...
						<div class="invoice-logo-res wid-50">
							<a href="restaurant_bill.html" class="logo"><img src="assets/images/hotel/restaurant-header-img.png" alt="this is a invoice logo"></a>
						</div>
					</div>
				</header>
				<!--Header end here -->
					...
					<div class="container">
						...
						<div class="invoice-owner-conte-wrap pt-20">
							...
							<div class="invo-pay-to-wrap">
								<div class="invoice-pay-content">
									...
									<h2 class="font-lg color-yellow pt-10">D'Podjok Garden</h2>
							...
							<table class="invoice-table restaurant-table">
								<thead>
									<tr class="invo-tb-header bg-yellow">
										<th class="font-md color-light-black res-no  pl-10">No.</th>
										<th class="font-md color-light-black w-40">Product</th>
						...
						<div class="rest-payment-bill">
							...
							<div class="signature-wrap">
								<div class="sign-img">
									<img src="assets/images/signature/sign.svg" alt="this is signature image">
								</div>
