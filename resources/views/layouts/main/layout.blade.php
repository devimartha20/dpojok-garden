...
<head>
    ...
    <!--[if lt IE 9]>
	  ...
	  <link rel="stylesheet" type="text/css" href="{{ asset('main/assets/icon/font-awesome/css/font-awesome.min.css') }}">
      <!-- ico font -->
      ...
      <link rel="stylesheet" type="text/css" href="{{ asset('main/assets/css/jquery.mCustomScrollbar.css') }}">
  </head>
            ...
            <nav class="navbar header-navbar pcoded-header">
               <div class="navbar-wrapper">
                   <div class="navbar-logo">
                       ...
                       <a href="index.html">
                           <img class="img-fluid" src="{{ asset('main/assets/images/logo.png') }}" alt="Theme-Logo" />
                       </a>
...
<!-- am chart -->
<script src="{{ asset('main/assets/pages/widget/amchart/amcharts.min.js') }}"></script>
<script src="{{ asset('main/assets/pages/widget/amchart/serial.min.js') }}"></script>
<!-- Chart js -->
<script type="text/javascript" src="{{ asset('main/assets/js/chart.js/Chart.js') }}"></script>
<!-- Todo js -->
<script type="text/javascript " src="{{ asset('main/assets/pages/todo/todo.js') }}"></script>
<!-- Custom js -->
<script type="text/javascript" src="{{ asset('main/assets/pages/dashboard/custom-dashboard.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('main/assets/js/script.js') }}"></script>
<script type="text/javascript " src="{{ asset('main/assets/js/SmoothScroll.js') }}"></script>
<script src="{{ asset('main/assets/js/pcoded.min.js') }}"></script>
<script src="{{ asset('main/assets/js/vartical-demo.js') }}"></script>
<script src="{{ asset('main/assets/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
</body>
